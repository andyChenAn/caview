<template>
  <div class="box">
    <div class="doc-title mb15">Statistic 统计数字</div>
    <div class="doc-desc mb15">展示统计数字</div>
    <br />
    <br />
    <div class="title2 mb15">代码演示</div>
    <div class="inner">
      <div style="margin-bottom: 20px">基本使用</div>
      <Statistic title="活动用户数" :value="1232453" />
      <Statistic title="活动用户数" :value="43532342" :precision="2" />
    </div>
    <div class="inner">
      <div style="margin-bottom: 20px">使用前缀和后缀</div>
      <Statistic title="点赞人数" :value="34532">
        <svg
          slot="suffix"
          t="1637659685079"
          class="icon"
      ...
      <Statistic title="未合并人数" :value="45">
        <span slot="suffix"> / 100</span>
      </Statistic>
    </div>
    <div class="inner">
      <div style="margin-bottom: 20px">在卡片中使用</div>
